...
| Pre-LLM         | [Retrieval Augmented Thinking](https://github.com/godiedelrio/agent-lifecycle-toolkit/tree/ddr/routing_toolkit/altk/pre_llm/routing_toolkit/retrieval_augmented_thinking) | *Does your agent struggle to route to the right tool?* Provide your agent with tool hints generated from tool domain content.                                                                                                                                                                                       |

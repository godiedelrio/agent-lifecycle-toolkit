...
| Pre-LLM         | [Retrieval Augmented Thinking](https://github.com/AgentToolkit/agent-lifecycle-toolkit/tree/main/altk/pre_llm/routing_toolkit/retrieval_augmented_thinking) | *Does your agent struggle to route to the right tool?* Provide your agent with tool hints generated from content from the tool domain.                                                                                                                                                                                       |
